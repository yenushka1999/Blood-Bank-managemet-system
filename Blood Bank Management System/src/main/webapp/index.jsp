...
<div style="max-width:100%">
  <img class="mySlides"  src="start1.png" >
...
<body>
  ...
  if("valid".equals(msg)){
	  %>
	  <center><font color="blue" size="5">Form Submitted Succesfully!You will get notified within 8 hours.</font></center>
	  <% 
  }
  %>
  <%
  ...
  if("invalid".equals(msg)){
	  %>
	  <center><font color="red" size="5">Invalid Data!Submit Again</font></center>
	  <% 
  }
  %>
